...
export function rsvToJson(rows) {
...
function stringToXmlElement(str) {
...
function containsSpecialWsvChar(value) {
...
function serializeWsvValue(value) {
	if (value === null) {
		return "-"
